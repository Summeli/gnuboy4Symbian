...
ViewController::ViewController()
{
    ...
    connect(settingsView, SIGNAL(LoadROM( QString,TGnuboySettings)), this, SLOT(loadROM( QString,TGnuboySettings)));
    ...
    connect(settingsView, SIGNAL(updateSettings(TGnuboySettings)), emuView, SLOT(updateSettings(TGnuboySettings)));
...
void ViewController::loadROM( QString rom, TGnuboySettings antSettings )
    {
    __DEBUG_IN
